...
public class GameChannelGroupManager {
	...
	public void init(EventExecutorGroup eventExecutorGroup,int channelMaxIdleTime,
		...
		count = 0;
		while (iterator.hasNext()) {
			gameChannelGroups[count++] = new GameChannelGroup( iterator.next(), channelMaxIdleTime,this.gameChannelInit);
		}
	}
